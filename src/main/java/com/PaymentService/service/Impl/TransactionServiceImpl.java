...
public class TransactionServiceImpl implements TransactionService {
    ...
    @Override
    public Response getAmountBetweenMinMax(AmountBetweenDto amountBetweenDto) {
        if (amountBetweenDto == null || amountBetweenDto.getMinAmount() == null ||
                amountBetweenDto.getMaxAmount() == null) {
            return ResponseBuilder.getFailResponse(HttpStatus.BAD_REQUEST, null,
                    "Invalid input: minAmount and maxAmount are required");
        }
        List<TransactionEntity> transactionEntityList =
                transactionRepository.findByAmountGreaterThanEqualAndAmountLessThanEqualAndStatus(amountBetweenDto.getMinAmount(),
                amountBetweenDto.getMaxAmount(), 1);
